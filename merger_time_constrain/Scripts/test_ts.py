...
BASE_DIR = f"/home/stu_jamsin/jamsin/grid_1_perday_noise_add_filt/{idx}"  # change as needed
if len(BASE_DIR) > 60:
...
for j in range(4): # change the range as needed (up to the number of time points - 1) /!\ update prior bounds if needed
    if ADD_UL:
